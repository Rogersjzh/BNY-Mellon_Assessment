...
char CommandName[] = "D:/AutoMod/14/bin/amod64.exe";
...
get_ldatt_address(load* this, int32 index, int32* d)
{
	...
	switch(index) {
	case 0:
		data = (void*)&this->attribute->am_model.am_A_qpointer;
		break;
	}
	return data;
}
...
set_attdata(load* this)
{
	...
	am_model.am_A_qpointer$att->data = (void*)&this->attribute->am_model.am_A_qpointer;
}
